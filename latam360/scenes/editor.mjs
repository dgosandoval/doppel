...
const assets = {
    ...
    biker: new pc.Asset('biker', 'gsplat', { url: 'https://playcanvas.vercel.app/static/assets/splats/biker.compressed.ply' }),
    apartment: new pc.Asset('apartment', 'gsplat', { url: 'https://playcanvas.vercel.app/static/assets/splats/apartment.sog' })
};
